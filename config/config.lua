...
Config.AllowVehicleTransfer = false -- Allow players to transfer vehicles to other players (true/false)

-- Admin Commands Configuration
Config.AdminCommands = {
    Enabled = true, -- Enable/disable admin commands
    AddVehicle = 'addveh', -- Command to add vehicle to player
    ChangePlate = 'changeplate', -- Command to change vehicle plate
    DeleteVehicle = 'delveh', -- Command to delete vehicle
    AdminGroups = { -- Groups that can use admin commands
        'admin',
        'superadmin',
        'god'
    }
